<?php
    ...
    if(count($_POST)>0) {
        ...
        $result = mysqli_query($mysqli,"SELECT * FROM admin_user WHERE username='" . mysqli_real_escape_string($mysqli, $_POST["username"]) . "' and password = '". mysqli_real_escape_string($mysqli, $_POST["password"])."'");
